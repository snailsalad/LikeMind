      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'If so, please enter your email and password \nbelow. Otherwise, click Cancel.',
              textAlign: TextAlign.center,
              style: FlutterFlowTheme.of(context).bodyMedium.override(
                    font: GoogleFonts.inter(
                      fontWeight:
            ...
            Row(
              ...
              children: [
                FFButtonWidget(
                  onPressed: () async {
                    logFirebaseEvent('DELETE_ACCOUNT_COMP_cancelButton_ON_TAP');
                    logFirebaseEvent('cancelButton_navigate_back');
                    context.safePop();
                  },
                  text: 'Cancel',
                ...
                FFButtonWidget(
                  onPressed: () async {
                    logFirebaseEvent('DELETE_ACCOUNT_COMP_submitButton_ON_TAP');
                    logFirebaseEvent('submitButton_custom_action');
                    _model.verified =
                        await actions.verifyPasswordFromFirebaseAuth(
                      _model.emailFieldTextController.text,
                      _model.passwordFieldTextController.text,
                    );
                    if (_model.verified == true) {
                      logFirebaseEvent('submitButton_auth');
                      await authManager.deleteUser(context);
                      logFirebaseEvent('submitButton_navigate_to');

                      context.goNamed(LoginSignupPageWidget.routeName);
