...
import '/pages/components/user_profile_small/user_profile_small_widget.dart';
import '/index.dart';
...
class _UserSearchWidgetState extends State<UserSearchWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('USER_SEARCH_userSearch_ON_INIT_STATE');
      logFirebaseEvent('userSearch_google_analytics_event');
      logFirebaseEvent('user_search_page');
    });
                ...
                Row(
                  ...
                  children: [
                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent(
                            'USER_SEARCH_PAGE_SearchButton_ON_TAP');
                        logFirebaseEvent('SearchButton_simple_search');
                        ...
                        logFirebaseEvent('SearchButton_google_analytics_event');
                        logFirebaseEvent('search_friends_button');
                      },
                      text: 'Search',
                        ...
                        return ListView.builder(
                          ...
                          itemBuilder: (context, searchResultsIndex) {
                            ...
                            return InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'USER_SEARCH_Container_dbv976zy_ON_TAP');
                                logFirebaseEvent(
                                    'userProfileSmall_navigate_to');
                                ...
                                context.pushNamed(
                                  ...
                                  extra: <String, dynamic>{
                                    'matchedUser': searchResultsItem,
                                  },
                                );
                              },
                              child: UserProfileSmallWidget(
                                key: Key(
                                    'Keydbv_${searchResultsIndex}_of_${searchResults.length}'),
                                user: searchResultsItem,
                              ),
                            );
                          },
                        );
