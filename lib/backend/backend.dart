...
Future<FFFirestorePage<NpsResponsesRecord>> queryNpsResponsesRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
  required PagingController<DocumentSnapshot?, NpsResponsesRecord> controller,
    ...
    queryCollectionPage(
      ...
      if (isStream) {
        final streamSubscription =
            (page.dataStream)?.listen((List<NpsResponsesRecord> data) {
          data.forEach((item) {
