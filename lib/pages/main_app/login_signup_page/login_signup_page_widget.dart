...
class LoginSignupPageWidget extends StatefulWidget {
  ...
  static String routeName = 'loginSignupPage';
  static String routePath = '/loginSignupPage';
...
class _LoginSignupPageWidgetState extends State<LoginSignupPageWidget>
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'loginSignupPage'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('LOGIN_SIGNUP_loginSignupPage_ON_INIT_STA');
      logFirebaseEvent('loginSignupPage_google_analytics_event');
      logFirebaseEvent('page_view_signup_login');
    });
                        ...
                        children: [
                          Align(
                            ...
                            child: TabBar(
                              ...
                              indicatorColor: Color(0xFFFFD343),
                              indicatorWeight: 2.0,
                              tabs: [
                                Tab(
                                  text: 'Signup',
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        width: double.infinity,
                                        child: TextFormField(
                                          key: ValueKey('SignupPassword_5py5'),
                                          controller: _model
                                      ...
                                      Container(
                                        width: double.infinity,
                                        child: TextFormField(
                                          key: ValueKey('SignUpConfirm_ggcb'),
                                          controller: _model
                                ...
                                Column(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      width: double.infinity,
                                      child: TextFormField(
                                        key: ValueKey('LoginPassword_950w'),
                                        controller:
                    ...
                    Stack(
                      children: [
                        if (_model.tabBarCurrentIndex == 1)
                          FFButtonWidget(
                            onPressed: () async {
                              ...
                              logFirebaseEvent('login_button');
                              if (valueOrDefault<bool>(
                                  currentUserDocument?.finishedOnboarding,
                                  false)) {
                        ...
                        if (_model.tabBarCurrentIndex == 0)
                          FFButtonWidget(
                            key: ValueKey('SignUpButton_2nw2'),
                            onPressed: () async {
                              logFirebaseEvent(
