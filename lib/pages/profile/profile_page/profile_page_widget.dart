                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: AuthUserStreamWidget(
                                      builder: (context) => Text(
                                        '${valueOrDefault(currentUserDocument?.school, '')}, ${valueOrDefault(currentUserDocument?.schoolYear, 0).toString()}',
                                        style: FlutterFlowTheme.of(context)
                                            .bodySmall
                                            .override(
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'PROFILE_PAGE_PAGE_changePassword_ON_TAP');
                                        logFirebaseEvent(
                                  ...
                                  Padding(
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        ...
                                        context.pushNamed(
                                            ProfileCreationSchoolSelectWidget
                                                .routeName);
                                      },
                                      child: Container(
                                        width: double.infinity,
